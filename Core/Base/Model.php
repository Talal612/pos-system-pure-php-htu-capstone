...
class Model
{
    ...
    protected function relate_table()
    {
        ...
        // var_dump($table_name); // example "Core\Model\Post"
        // echo "<br>";
        $table_name_arr = \explode('\\', $table_name);
        // var_dump($table_name_arr); //{ [0]=> string(4) "Core" [1]=> string(5) "Model" [2]=> string(4) "Post" }
        // echo "<br>";
        // var_dump(\array_key_last($table_name_arr)); // 2
        // echo "<br>";
        $class_name = $table_name_arr[\array_key_last($table_name_arr)]; // $table_name_arr[2]
        // var_dump($class_name); // Post
        // echo "<br>";
        $final_class_name = \strtolower($class_name) . "s";
        // var_dump($final_class_name); // posts
        // die();
        $this->table = $final_class_name;  // this->table = posts
    }
}